...
func TestAdmit(t *testing.T) {
	...
	defaultRoleBinding := &v1.RoleBinding{
		ObjectMeta: metav1.ObjectMeta{
			Name: "default",
		},
	}
	emptyLabelsRoleBinding := &v1.RoleBinding{
		ObjectMeta: metav1.ObjectMeta{
			Labels: map[string]string{},
			Name:   "default",
		},
	}
	roleBindingWithOwnerLabel := &v1.RoleBinding{
		ObjectMeta: metav1.ObjectMeta{
			Name: "default",
			Labels: map[string]string{
	...
	roleBindingWithNewOwnerLabel := &v1.RoleBinding{
		ObjectMeta: metav1.ObjectMeta{
			Name: "default",
			Labels: map[string]string{
